...
/**
 * WiseAnalytics DI container.
 *
 * @author Kainex <contact@kainex.pl>
 */
class WiseAnalyticsContainerl {
	/**
	...
	*/
	...
	public static function getLazy($classPathAndName) {
		...
		self::$proxies[$classPathAndName] = new WiseAnalyticsContainerProxyClass($classPathAndName);
...
/**
 * Wise Analytics DI proxy class.
 */
class WiseAnalyticsContainerProxyClass {
	/**
	 * @var string
	 */
	...
	/**
	 * WiseAnalyticsContainerProxyClass constructor.
	 *
	 * @param string $classPathAndName
	 */
	...
	public function __call($name, $arguments) {
		if ($this->targetClassObject === null) {
			$this->targetClassObject = WiseAnalyticsContainer::get($this->targetClassPathAndName);
		}
